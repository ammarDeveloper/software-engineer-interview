  ...
  - [Fundamentals](#fundamentals)
    ...
    - [Event Loop](#event-loop)
      - [**Execuation of above phases with queues:**](#execuation-of-above-phases-with-queues)
        ...
        - [**Poll phase or I/O Queue**](#poll-phase-or-io-queue)
...
- [Authentication \& Security in Node.js: Comprehensive Guide](#authentication--security-in-nodejs-comprehensive-guide)
  ...
  - [8. SQL/NoSQL Injection Prevention](#8-sqlnosql-injection-prevention)
  ...
  - [10. HTTPS Implementation](#10-https-implementation)
    ...
    - [Implementation Steps](#implementation-steps-1)
      - [1. Obtain SSL/TLS Certificate](#1-obtain-ssltls-certificate)
...
A callback is a function that is passed as an argument to another function, to be called later (usually after an async task is done).
...
A Promise is an object representing the eventual completion (or failure) of an async operation. It helps avoid callback hell.
...
This is syntactic sugar over Promises that makes async code look like synchronous code. It’s cleaner and easier to read.
...
Let’s say you want to read a 5GB video file.

❌ If you use fs.readFile(), Node will try to load the whole 5GB into memory. Ouch.
✅ With a stream, Node reads it chunk by chunk, saving memory and making it faster and scalable
